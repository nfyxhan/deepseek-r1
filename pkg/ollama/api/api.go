...
func (c *Client) do(ctx context.Context, method, path string, reqData, respData any) error {
	...
	c.base.Path = path
	request, err := http.NewRequestWithContext(ctx, method, c.base.String(), reqBody)
	if err != nil {
		return err
	}
	...
	request.Header.Set("User-Agent", fmt.Sprintf("ollama/%s (%s %s) Go/%s", "", runtime.GOARCH, runtime.GOOS, runtime.Version()))
...
func (c *Client) stream(ctx context.Context, method, path string, data any, fn func([]byte) error) error {
	...
	c.base.Path = path
	request, err := http.NewRequestWithContext(ctx, method, c.base.String(), buf)
	if err != nil {
		return err
	}
